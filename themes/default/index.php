			...
			<div class="section dt_filters bg_gradient">
				<div class="row">
					...
					<div class="col" style="padding-top: 15px;">
						<a href="<?php echo $site_url;?>/login" class="waves-effect waves-light btn-flat btn-small bold btn_glossy"><?php echo __( 'Let\'s Begin' );?></a>
					</div>
				</div>
			</div>
		</div>
                    ...
                    <div class="section">
                        <div class="row" style="height: 600px;">
                            <div class="col s12 center-align dt_get_start">
                                <h4 class="white-text light"><?php echo str_replace('{0}', ucfirst( $config->site_name ) ,  'All {0} users.'  );?></h4>
                                <div class="center">
                                    <?php
                                    foreach ($siteUsers as $key => $user){ ?>
                                        <a href="<?php echo $site_url;?>/@<?php echo $user->username;?>" data-ajax="/@<?php echo $user->username;?>">
                                            ...
                                            <img src="<?php echo $user->mediafiles[0][avater]; ?>" alt="<?php echo $user->full_name;?>" class="circle xuser">
                                            <img src="http://www.slatecube.com/images/play-btn.png" alt="play" class="playBtn">
                                            </span>
                                        </a>
                                    <?php } ?>
                                </div>
				...
				<div class="section">
					<div class="row" style="height: 70px;">
						<div class="col s12 center-align dt_get_start">
							...
							<a href="<?php echo $site_url;?>/register" class="waves-effect waves-light btn-flat btn-small bold btn_glossy"><?php echo __( 'Get Started' );?></a>
						</div>
					</div>
				</div>
			</div>
